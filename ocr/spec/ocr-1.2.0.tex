...
\newcommand{\footerText}{OCR -- Version 1.2.0 (Candidate release) -- December 2016}
...
%    \linenumbers\pagewiselinenumbers
   ...
   % VS: Bibliography can be moved to a different point
    ...
    \input{Source/app-A-examples}

    \input{Source/app-B-api-extensions}

   \input{Source/app-C-implementations}

    \input{Source/app-D-history}
