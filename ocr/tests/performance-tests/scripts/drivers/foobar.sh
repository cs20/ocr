...
#
# Build OCR unless bypass is set
#
if [[ -z "${BYPASS_OCR_BUILD}" ]]; then
    export CFLAGS_USER="${CFLAGS_USER} -DINIT_DEQUE_CAPACITY=2500000 -DGUID_PROVIDER_NB_BUCKETS=2500000 -DELS_USER_SIZE=0"
    buildOcr
fi
