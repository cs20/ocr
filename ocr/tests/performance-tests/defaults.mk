...
C_DEFINES := $(C_DEFINES) -DENABLE_EXTENSION_AFFINITY -DENABLE_EXTENSION_RTITF -DENABLE_EXTENSION_PARAMS_EVT -DENABLE_EXTENSION_COUNTED_EVT -DENABLE_EXTENSION_CHANNEL_EVT\
