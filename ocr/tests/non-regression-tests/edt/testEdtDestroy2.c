...
ocrGuid_t finishEdt(u32 paramc, u64* paramv, u32 depc, ocrEdtDep_t depv[]) {
    ...
    ocrPrintf("Created work EDT "GUIDF"\n", GUIDA(edtGuid));
    ...
    ocrPrintf("Destroyed work EDT "GUIDF"\n", GUIDA(edtGuid));
    return NULL_GUID;
}
...
ocrGuid_t mainEdt(u32 paramc, u64* paramv, u32 depc, ocrEdtDep_t depv[]) {
    ...
    ocrPrintf("Created finish EDT "GUIDF" with outputEvent "GUIDF"\n", GUIDA(edtGuid), GUIDA(outputEventGuid));
    ocrGuid_t shutGuid;
    ...
    ocrPrintf("Created shutdown EDT "GUIDF"\n", GUIDA(shutGuid));
